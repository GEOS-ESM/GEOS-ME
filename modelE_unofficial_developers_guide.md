...
Note that modelE creates a custom executable for each run. So in the example on this page you would get a geos_run.exe file. To run it directory you can go to /Path_to_somewhere/ModelE_Support/huge_space/geos_run, the the ./geos_runln script that will link in the boundary conditions. To run modelE do:
```
